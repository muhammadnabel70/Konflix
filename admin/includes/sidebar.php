<div class="admin-sidebar">
    ...
    <a href="video_manage.php" class="menu-item">Kelola Video</a> 
    <a href="users.php" class="menu-item">Kelola Pengguna</a> 
    <a href="../index.php" class="menu-item" style="margin-top:auto; background:#220000; color:#ffaaaa;">
